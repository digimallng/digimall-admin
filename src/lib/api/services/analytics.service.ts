...
export class AnalyticsService {
  ...
  async getRevenueData(params?: {
    ...
    try {
      const response = await apiClient.get('/api/proxy/admin/v1/analytics/revenue', params);
  ...
  async getCategoryStats(params?: {
    ...
    try {
      const response = await apiClient.get('/api/proxy/admin/v1/analytics/categories', params);
  ...
  async getUserAnalytics(params?: {
    ...
    try {
      const response = await apiClient.get('/api/proxy/admin/v1/analytics/users', params);
  ...
  async getVendorAnalytics(params?: {
    ...
    try {
      const response = await apiClient.get('/api/proxy/admin/v1/analytics/vendors', params);
  ...
  async getProductAnalytics(params?: {
    ...
    try {
      const response = await apiClient.get('/api/proxy/admin/v1/analytics/products', params);
  ...
  async getOrderAnalytics(params?: {
    ...
    try {
      const response = await apiClient.get('/api/proxy/admin/v1/analytics/orders', params);
  ...
  async getSystemMetrics() {
    try {
      const response = await apiClient.get('/api/proxy/admin/v1/analytics/system');
  ...
  async exportAnalytics(params: {
    ...
    try {
      const response = await apiClient.get('/api/proxy/admin/v1/analytics/export', params);
